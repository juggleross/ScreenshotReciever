...
class ScreenshotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screenshot" do
    assert_difference('Screenshot.count') do
      post screenshots_url, params: { screenshot: { name: @screenshot.name, photo: @screenshot.photo } }
    end
  ...
  test "should update screenshot" do
    patch screenshot_url(@screenshot), params: { screenshot: { name: @screenshot.name, photo: @screenshot.photo } }
